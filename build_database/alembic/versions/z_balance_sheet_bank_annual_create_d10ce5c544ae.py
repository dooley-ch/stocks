"""z_balance_sheet_bank_annual create

Revision ID: d10ce5c544ae
Revises: 54d42ea7310e
Create Date: 2022-10-24 16:48:55.623374
...
revision = 'd10ce5c544ae'
down_revision = '54d42ea7310e'
branch_labels = None
depends_on = None


def upgrade() -> None:
    op.create_table('z_balance_sheet_bank_annual',
    ...
    op.create_index('z_balance_sheet_bank_annual_ticker', 'z_balance_sheet_bank_annual', ['ticker'])
    op.create_index('z_balance_sheet_bank_annual_simfin_id', 'z_balance_sheet_bank_annual', ['simfin_id'])


def downgrade() -> None:
    op.drop_index('z_balance_sheet_bank_annual_ticker', 'z_balance_sheet_bank_annual')
    op.drop_index('z_balance_sheet_bank_annual_simfin_id', 'z_balance_sheet_bank_annual')
    op.drop_table('z_balance_sheet_bank_annual')
