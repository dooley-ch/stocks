"""z_balance_sheet_general_quarter create

Revision ID: fb16c9380db6
Revises: 948e35527c90
Create Date: 2022-10-24 17:07:59.179876
...
revision = 'fb16c9380db6'
down_revision = '948e35527c90'
branch_labels = None
depends_on = None


def upgrade() -> None:
    op.create_table('z_balance_sheet_general_quarter',
    ...
    op.create_index('z_balance_sheet_general_quarter_ticker', 'z_balance_sheet_general_quarter', ['ticker'])
    op.create_index('z_balance_sheet_general_quarter_simfin_id', 'z_balance_sheet_general_quarter', ['simfin_id'])


def downgrade() -> None:
    op.drop_index('z_balance_sheet_general_quarter_ticker', 'z_balance_sheet_general_quarter')
    op.drop_index('z_balance_sheet_general_quarter_simfin_id', 'z_balance_sheet_general_quarter')
    op.drop_table('z_balance_sheet_general_quarter')
