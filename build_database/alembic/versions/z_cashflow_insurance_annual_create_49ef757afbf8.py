"""z_cashflow_insurance_annual create

Revision ID: 49ef757afbf8
Revises: e4c18e4e5570
Create Date: 2022-10-24 17:12:19.306572
...
revision = '49ef757afbf8'
down_revision = 'e4c18e4e5570'
branch_labels = None
depends_on = None


def upgrade() -> None:
    op.create_table('z_cashflow_insurance_annual',
    ...
    op.create_index('z_cashflow_insurance_annual_ticker', 'z_cashflow_insurance_annual', ['ticker'])
    op.create_index('z_cashflow_insurance_annual_simfin_id', 'z_cashflow_insurance_annual', ['simfin_id'])


def downgrade() -> None:
    op.drop_index('z_cashflow_insurance_annual_ticker', 'z_cashflow_insurance_annual')
    op.drop_index('z_cashflow_insurance_annual_simfin_id', 'z_cashflow_insurance_annual')
    op.drop_table('z_cashflow_insurance_annual')
